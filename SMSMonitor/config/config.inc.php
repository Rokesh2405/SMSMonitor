...
if ($_SERVER['HTTP_HOST'] == 'localhost') {
    $db = new PDO('mysql:host=localhost;dbname=smsmonitor;charset=utf8mb4', 'root', '');
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $db->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
    $sitename = 'http://localhost/ttbilling/smsmonitor/';
    $fsitename = 'http://localhost/ttbilling/smsmonitor/';
    $actual_link = "http://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
    define('WEB_ROOTS', $fsitename);
    define('WEB_ROOT', $sitename);
    $docroot = $_SERVER['DOCUMENT_ROOT'] . "/smsmonitor/";
} else {
    $db = new PDO('mysql:host=localhost;dbname=smsmonitor;charset=utf8mb4', 'smsmonitor', 'u#KhFv@ti@');
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $db->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
    $connection_string = mysqli_connect("localhost", "smsmonitor", 'u#KhFv@ti@', "smsmonitor");
    $sitename = "https://ttbilling.in/smsmonitor/";
    $site = 'https://ttbilling.in/smsmonitor/';
    $fsitename = 'https://ttbilling.in/smsmonitor/';
